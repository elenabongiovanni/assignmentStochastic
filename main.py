...
num_reduce = 20
NV_best_subset_W, NV_best_distance_W = reduce_scenarios_wasserstein(scenari_NewsVendor, num_reduce, p=2)
...
ATO_best_subset_W, ATO_best_distance_W = reduce_scenarios_wasserstein(scenari_ATO, num_reduce, p=2)
