...
def save_ato_results(val_mc, val_mm, dist_mm, val_w, dist_w, filename="ATO_results.txt"):
    path = os.path.join("result", filename)
    with open(path, "w") as f:
        f.write("=== RISULTATI ATO ===\n")
        ...
        print(f"[✓] Risultati ATO salvati in {path}")
...
def save_ato_results_stability(val_mc=None, val_mm=None, dist_mm=None, val_w=None, dist_w=None,
    ...
    print(f"[✓] Stabilità ATO salvata in {path}")
